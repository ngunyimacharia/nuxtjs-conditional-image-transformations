<template>
  <div>
    <h1 class="text-center font-bold text-2xl my-10">
      Conditional image transformations in Nuxt.Js
    </h1>
    <client-only>
        ...
        <div class="grid grid-cols-4">
          <div class="p-3 flex flex-col justify-end">
            ...
            <p class="mt-5 text-center text-sm">
              Cartoonify if inital width is greater than 4300px
            </p>
          </div>
          <div class="p-3 flex flex-col justify-end">
            <cld-image :publicId="image.publicId">
            ...
            <p class="mt-5 text-center text-sm">
              Oil paint if inital height is greater than 3000px
            </p>
          </div>
          <div class="p-3 flex flex-col justify-end">
            <cld-image :publicId="image.publicId">
            ...
            <p class="mt-5 text-center text-sm">
              Pad horizontally or vertically if aspect ratio is less or greater
              than 1.0
            </p>
          </div>
          <div class="p-3 flex flex-col justify-end">
            ...
            <p class="mt-5 text-center text-sm">
              If face is detected, crop around it and apply vignette
            </p>
          </div>
        </div>
      </div>
  ...
  data() {
    return {
      images: [
        {
          publicId:
            "nuxtjs-conditional-image-transformations/pexels-micheilecom-_-visual-stories-11573079.jpg",
          credit: "Photo by micheile.com || visual stories from Pexels",
        },
        {
          publicId:
            "nuxtjs-conditional-image-transformations/pexels-anastasiia-goncharova-11659832.jpg",
          credit: "Photo by Danil Lysov from Pexels",
        },
        {
          publicId:
            "nuxtjs-conditional-image-transformations/pexels-megan-ruth-11494641.jpg",
          credit: "Photo by Anastasiia Goncharova from Pexels",
        },
        {
          publicId:
            "nuxtjs-conditional-image-transformations/pexels-danil-lysov-11741441.jpg",
          credit: "Photo by Anastasiia Goncharova from Pexels",
        },
      ],
    };
